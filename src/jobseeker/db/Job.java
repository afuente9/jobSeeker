...
public class Job implements Serializable {
	...
	@Override
	public String toString() {  //Importante para nuestra practica
		return "Job [id=" + id + ", name=" + name + ", description=" + description + ", salary=" + salary
				+ ", startDate=" + startDate + ", endDate=" + endDate + "]";
	}

	public void addPerson(Person person) { //Importante para nuestra practica
		if(!people.contains(person)) {
			people.add(person);
		}
	}
	
	public void removePerson(Person person) { //Importante para nuestra practica
		if(people.contains(person)) {
